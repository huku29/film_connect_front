...
export const PrivacyPolicy = () => {
  ...
  return (
    <BaseLayout>
      ...
      <Box sx={{ ml: 5, mb: 8 }}>
        <Box sx={{ mb: 5 }}>
          <Typography variant="h5" sx={{fontWeight: 'bold' }}>お客様から取得する情報</Typography>
        ...
        <Box sx={{ mb: 5 }}>
          <Typography variant="h5" sx={{fontWeight: 'bold' }}>お客様の情報を利用する目的</Typography>
        ...
        <Box sx={{ mb: 5 }}>
          <Typography variant="h5" sx={{fontWeight: 'bold' }}>安全管理のために講じた措置</Typography>
          当サイトが、お客様から取得した情報に関して安全管理のために講じた措置につきましては、末尾記載のお問い合わせ先にご連絡をいただきましたら、
          法令の定めに従い個別にご回答させていただきます。
        </Box>
        <Box sx={{ mb: 5 }}>
          <Typography variant="h5" sx={{fontWeight: 'bold' }}>第三者提供</Typography>
        ...
        <Box sx={{ mb: 5 }}>
          <Typography variant="h5" sx={{fontWeight: 'bold' }}>アクセス解析ツール</Typography>
        ...
        <Box sx={{ mb: 5 }}>
          <Typography variant="h5"  sx={{fontWeight: 'bold' }}> プライバシーポリシーの変更</Typography>
          当サイトは、必要に応じて、このプライバシーポリシーの内容を変更します。この場合、変更後のプライバシーポリシーの施行時期と内容を適切な方法により周知または通知します。
        </Box>
        <Box sx={{ mb: 5 }}>
          <Typography variant="h5" sx={{fontWeight: 'bold' }}> お問い合わせ </Typography>
