...
export const registerFirstSawFilm = `${import.meta.env.VITE_DEFAULT_API_URL}/api/v1/first_saw_movies`;
export const firstSawFilmLettersRanking = `${import.meta.env.VITE_DEFAULT_API_URL}/api/v1/first_saw_movies/rank`;
export const getSawFilmLettersData = `${import.meta.env.VITE_DEFAULT_API_URL}/api/v1/first_saw_movies/info`;
export const getNotWatchFilmLetters = `${import.meta.env.VITE_DEFAULT_API_URL}/api/v1/first_saw_movies`;
export const getNotWatchFilmLetterDetails = `${import.meta.env.VITE_DEFAULT_API_URL}/api/v1/first_saw_movies/movie_letter_details`;
